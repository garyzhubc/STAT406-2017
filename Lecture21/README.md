...
The lecture slides are [here](STAT406-17-lecture-21.pdf).
...
![](README_files/figure-markdown_github-ascii_identifiers/force.noise.mclust-1.png)

``` r
pairs(x.5[,1:3], col=m5.3$class, pch=19)
```

![](README_files/figure-markdown_github-ascii_identifiers/force.noise.mclust-2.png)
...
![](README_files/figure-markdown_github-ascii_identifiers/force.noise.kmeans-1.png)

``` r
pairs(x.5[,1:3], col=m5.l[[3]]$cluster, pch=19)
```

![](README_files/figure-markdown_github-ascii_identifiers/force.noise.kmeans-2.png)
