...
We now show the effect of bagging. We average the predicted conditional probabilities,
and we *bagg* prunned trees. 
...
```{r bag2, fig.width=6, fig.height=6, message=FALSE, warning=FALSE}
mm2 <- mm
mm2[1,3] <- 2
mm2[7,3] <- 2
