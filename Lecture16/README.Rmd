...
and we *bagg* large trees. Note that the predicted probabilities 
...
```
Predictions can be obtained using the `predict` method, as usual. 
...
and also, their importance rank we use the function `varImpPlot`:
