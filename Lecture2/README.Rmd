...
Here we continue studying the problem of estimating the
prediction power of different models. We consider 
...
reduced one, its predictions on the test set are better:
```{r pred1}
...
```
In the last class, we also saw that 
this result is not an artifact of the specific
training / test split of the data. 

Another procedure to estimate the prediction power
