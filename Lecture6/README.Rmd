...
estimator, give that it is the solution of a constrained
...
of the Ridge Regression fit to the air pollution data when 
the penalty parameter is considered to be fixed at the  
